"""AWS DynamoDB implementation of frame submission claims."""
        ...
        *,
        ...
        try:
            response = self.ddb.update_item(
                ...
                Key={
                    "pk": _dynamo_s(
                        frame_claim_pk(dataset_id=dataset_id, cycle=cycle, run_id=run_id, frame_id=frame_id)
                    )
                },
                UpdateExpression=update_expression,
                ConditionExpression=("attribute_not_exists(pk) OR expires_at_epoch < :now OR #state <> :claimed"),
        ...
        *,
        ...
        self.ddb.update_item(
            ...
            ExpressionAttributeValues={
                ...
                ":updated_at": _dynamo_s(isoformat_utc(now)),
            },
        )
