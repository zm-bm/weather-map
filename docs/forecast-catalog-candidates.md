...
| --- | --- | --- | --- | --- | --- | --- |
| `precipitation_type` | Precipitation Type | `precipitation` | Selectable categorical layer from `precip_type_surface`. | GFS/ICON already publish this as a supporting classifier. | Settle now | Needs a categorical legend. Keep the existing `precipitation_rate` overlay behavior. |
