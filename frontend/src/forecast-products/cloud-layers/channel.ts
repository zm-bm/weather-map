...
export function createCloudLayersChannel(args: CreateCloudLayersChannelArgs): ForecastProductChannel<CloudLayersTimeSliceData> {
  assertCloudLayersSource(args.layer)
