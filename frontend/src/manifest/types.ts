...
export type ProductKind = 'scalar' | 'vector'
...
export type ScalarProductSpec = ManifestProductBaseSpec & { kind: 'scalar', encoding: ScalarEncodingSpec }

export type VectorProductSpec = ManifestProductBaseSpec & { kind: 'vector', encoding: VectorEncodingSpec }
