...
export const BASEMAP_THEME_PAINT_KEYS: readonly BasemapPaintKey[] = [
  ...
  { layerId: BASEMAP_LAYER_IDS.landcoverContext, property: 'fill-color' },
  { layerId: BASEMAP_LAYER_IDS.landcoverContext, property: 'fill-opacity' },
  { layerId: BASEMAP_LAYER_IDS.landuseContext, property: 'fill-color' },
  { layerId: BASEMAP_LAYER_IDS.landuseContext, property: 'fill-opacity' },
...
const CLOUD_LAYERS_BASEMAP_PAINT_OVERRIDES: readonly BasemapPaint[] = [
  ...
  { layerId: BASEMAP_LAYER_IDS.landcoverContext, property: 'fill-opacity', value: 0.16 },
  { layerId: BASEMAP_LAYER_IDS.landuseContext, property: 'fill-color', value: 'rgb(92, 89, 65)' },
  { layerId: BASEMAP_LAYER_IDS.landuseContext, property: 'fill-opacity', value: 0.2 },
  ...
  { layerId: BASEMAP_LAYER_IDS.roadMajor, property: 'line-color', value: 'rgb(70, 64, 46)' },
  {
    ...
    value: ['interpolate', ['linear'], ['zoom'], 4, 0.12, 5, 0.22, 7, 0.34, 10, 0.48],
  },
